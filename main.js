...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨 𝐎𝐬𝐢𝐭𝐨 @user 𝐄𝐬𝐩𝐞𝐫𝐨 𝐓𝐞 𝐬𝐢𝐞𝐧𝐭𝐚𝐬 𝐂𝐨𝐦𝐨𝐝𝐨!! 🐼';
  conn.bye = '@user 𝐔𝐧𝐚 𝐩𝐥𝐚𝐧𝐭𝐚 𝐌𝐞𝐧𝐨𝐬 𝐐𝐮𝐞 𝐛𝐮𝐞𝐧𝐨 𝐪𝐮𝐞 𝐭𝐞 𝐯𝐚𝐬 𝐉𝐚𝐣𝐚𝐣𝐚 𝐛𝐲𝐞 𝐛𝐲𝐞🐼💋!! ';
  conn.spromote = '@user 𝐒𝐞 𝐬𝐮𝐦𝐚 𝐀 𝐥𝐨𝐬 𝐎𝐬𝐢𝐭𝐨𝐬 𝐀𝐝𝐦𝐢𝐧𝐬 ';
  conn.sdemote = '@user 𝐒𝐞 𝐛𝐚𝐣𝐚 𝐝𝐞 𝐥𝐨𝐬 𝐎𝐬𝐢𝐭𝐨𝐬 𝐀𝐝𝐦𝐢𝐧𝐬 ';
  conn.sDesc = '𝐋𝐚 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐜𝐢𝐨𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐒𝐞 𝐌𝐨𝐝𝐢𝐟𝐢𝐜𝐨';
  conn.sSubject = '𝐒𝐞 𝐇𝐚 𝐜𝐚𝐦𝐛𝐢𝐚𝐝𝐨 𝐞𝐥 𝐧𝐨𝐦𝐛𝐫𝐞 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐧𝐮𝐞𝐯𝐚 𝐈𝐦𝐚𝐠𝐞𝐧 𝐎𝐬𝐢𝐭𝐨𝐬 🐼';
  conn.sIcon = ' 𝐒𝐞 𝐇𝐚 𝐜𝐚𝐦𝐛𝐢𝐚𝐝𝐨 𝐥𝐚 𝐟𝐨𝐭𝐨 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐧𝐮𝐞𝐯𝐚 𝐈𝐦𝐚𝐠𝐞𝐧 𝐎𝐬𝐢𝐭𝐨𝐬 🐼';
  conn.sRevoke = '𝐄𝐥 𝐄𝐧𝐥𝐚𝐜𝐞 𝐃𝐞 𝐢𝐧𝐯𝐢𝐭𝐚𝐜𝐢𝐨𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐚𝐡 𝐬𝐢𝐝𝐨 𝐫𝐞𝐬𝐭𝐚𝐛𝐥𝐞𝐜𝐢𝐝𝐨 🐼';
